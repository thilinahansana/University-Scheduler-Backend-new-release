...
def evaluate_solution(solution):
    ...
    hard_conflicts = 1000 * (room_conflicts + teacher_conflicts + interval_conflicts + teacher_availability_conflicts + capacity_conflicts + unscheduled_activities + duplicate_activities + room_type_mismatches + subgroup_conflicts) + new_hard_penalties
